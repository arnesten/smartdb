...
var url = require('url');
var inMemoryCacheProvider = require('./inMemoryCacheProvider.js');
...
module.exports.caches = {
	inMemoryCacheProvider: require('./inMemoryCacheProvider.js'),
	nullCacheProvider: require('./nullCacheProvider.js')
};